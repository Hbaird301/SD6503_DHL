        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<AccountDetail>(entity =>
            {
                entity.HasKey(e => e.AccountNumber)
                    .HasName("PK__AccountD__BE2ACD6EFBDB996A");
                ...
                entity.HasOne(d => d.IdentifierNavigation)
                    ...
                    .HasConstraintName("FK__AccountDe__Ident__4D94879B");
            });

            modelBuilder.Entity<LoginAccount>(entity =>
            {
                entity.HasKey(e => e.Identifier)
                    .HasName("PK__LoginAcc__821FB01876389116");
            ...
            modelBuilder.Entity<TransactionTable>(entity =>
            {
                entity.HasKey(e => e.TransactionNumber)
                    .HasName("PK__Transact__E733A2BEFBB227B4");
                ...
                entity.HasOne(d => d.FromAccountNavigation)
                    ...
                    .HasConstraintName("FK__Transacti__FromA__534D60F1");
            });
