...
namespace SD6503_DHl.Controllers
{
    public class TransactionTablesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("TransactionNumber,ToAccount,FromAccount,PaymentAmount,TransactionAmount,PaymentPeriod")] TransactionTable transactionTable)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TransactionNumber,ToAccount,FromAccount,PaymentAmount,TransactionAmount,PaymentPeriod")] TransactionTable transactionTable)
        {
