...
namespace SD6503_DHl.Controllers
{
    public class LoginAccountsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Username,Password,Identifier")] LoginAccount loginAccount)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Username,Password,Identifier")] LoginAccount loginAccount)
        {
        ...
        private bool LoginAccountExists(string id)
        {
